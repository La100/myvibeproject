  ...
  return (
    <div className="flex h-full flex-col px-4 pb-4 pt-5">
      <div className="mb-4 flex items-start justify-between">
        <div>
          <p className="vp-title">Twoje zespoły</p>
          <h2 className="mt-1 text-xl font-semibold">Wybierz przestrzeń pracy</h2>
        </div>
      ...
      <div className="clean-panel mb-3 flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="font-semibold">{teams.length} zespołów</span>
        </div>
      ...
      {teams.length === 0 ? (
        <div className="clean-panel flex flex-1 flex-col items-center justify-center px-6 text-center">
          ...
          <h3 className="mb-1 text-base font-semibold">Brak zespołów</h3>
          <p className="text-sm text-muted-foreground">
            Musisz należeć do zespołu, aby używać rozszerzenia.
          </p>
        </div>
      ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {team.projects.length} projektów
                      </p>
                    </div>
                  </div>
